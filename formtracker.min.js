...
jQuery(function($){$.initSAFormTracker=function(credentials){$('form').on('submit',function(e){$(this).append('<input type="hidden" name="trueSource" value="'+sessionStorage.source+'">');$(this).append('<input type="hidden" name="SAFormName" value="'+(($(this).attr('name')==undefined||$(this).attr('name')==null||$(this).attr('name')=='')?$(this).attr('action'):$(this).attr('name'))+'">');$.ajax({url:"https://dash.socialagencyinc.com/formtracker/submission/"+credentials.accountId+"/"+credentials.accessToken,headers:{"Content-Type":'application/x-www-form-urlencoded'},method:"POST",data:$(this).serializeArray(),async:!1});delete(sessionStorage.source)});if(sessionStorage.source==undefined){sessionStorage.source=document.referrer}
console.log("-- SA FORM TRACKER INITIALIZED --");console.log("-- SA FORM TRACKER VERSION 1.4 --")}})