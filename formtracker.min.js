...
jQuery(function($){$.initSAFormTracker=function(credentials){$('form').on('submit',function(e){$.ajax({url:"https://dash.socialagencyinc.com/formtracker/submission/"+credentials.accountId+"/"+credentials.accessToken,headers:{"Content-Type":'application/x-www-form-urlencoded'},method:"POST",data:$(this).serializeArray(),async:!1})})}})